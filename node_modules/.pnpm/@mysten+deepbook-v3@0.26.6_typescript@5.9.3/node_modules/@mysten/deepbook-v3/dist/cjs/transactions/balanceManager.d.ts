...
export declare class BalanceManagerContract {
     ...
     * @returns A function that takes a Transaction object
     */
    createBalanceManagerWithOwner: (ownerAddress: string) => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
    /**
     ...
     * @returns A function that takes a Transaction object
     */
    balanceManagerReferralOwner: (referralId: string) => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
    /**
     ...
     * @returns A function that takes a Transaction object
     */
    balanceManagerReferralPoolId: (referralId: string) => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
    /**
     ...
     * @returns A function that takes a Transaction object
     */
    getBalanceManagerReferralId: (managerKey: string, poolKey: string) => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
    /**
