...
export declare class MarginLiquidationsContract {
     ...
     */
    withdraw: (vaultId: string, liquidationAdminCap: string, coinKey: string, amount: number) => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
    /**
     ...
     * @returns A function that takes a Transaction object
     */
    balance: (vaultId: string, coinKey: string) => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
}
