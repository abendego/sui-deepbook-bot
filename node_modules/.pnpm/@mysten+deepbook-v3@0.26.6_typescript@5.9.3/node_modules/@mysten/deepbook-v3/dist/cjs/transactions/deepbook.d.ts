...
export declare class DeepBookContract {
     ...
     * @returns A function that takes a Transaction object
     */
    getPoolReferralBalances: (poolKey: string, referral: string) => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
    /**
     ...
     * @returns A function that takes a Transaction object
     */
    poolReferralMultiplier: (poolKey: string, referral: string) => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
    /**
