 ...
 */
export declare class MarginAdminContract {
    #private;
    /**
     ...
     */
    mintMaintainerCap: () => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
    /**
     ...
     * @returns A function that takes a Transaction object
     */
    newPoolConfig: (poolKey: string, poolConfigParams: PoolConfigParams) => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
    /**
     ...
     * @returns A function that takes a Transaction object
     */
    newCoinTypeData: (coinKey: string, maxConfBps: number, maxEwmaDifferenceBps: number) => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
    /**
    ...
    }>, maxAgeSeconds: number) => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
    /**
     * @description Mint a pause cap
     * @returns A function that takes a Transaction object
     */
    mintPauseCap: () => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
    /**
     ...
     */
    adminWithdrawDefaultReferralFees: (coinKey: string) => (tx: Transaction) => import("@mysten/sui/transactions").TransactionResult;
}
