 ...
 */
export declare function validateRequired<T>(value: T | undefined, errorMessage: string): T;
/**
 ...
 */
export declare function validateNonNegativeNumber(value: number, fieldName: string): number;
/**
 ...
 */
export declare function validateNonEmptyArray<T>(array: T[], fieldName: string): T[];
